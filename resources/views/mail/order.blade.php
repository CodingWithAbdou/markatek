                            ...
                            <tr width="640" style="width: 640px; min-width: 640px; " align="center">
                                <td>
                                    <table cellpadding="0" cellspacing="0" border="0" align="center" width="640"
                                        ...
                                        <tr>
                                            <td height="35" bgcolor="#383e56"
                                                style="line-height:35px;min-height:35px;">
                                            </td>
                                        </tr>
                                    </table>
                                    <table cellpadding="0" cellspacing="0" border="0" width="640"
                                        bgcolor="#383e56" style="width: 640px; min-width: 640px;" role="presentation"
                                        align="center">
                                        <tr>
                                            <td align="{{ getLocale() == 'ar' ? 'right' : 'left' }}">
                                                <table cellpadding="0" cellspacing="0" border="0"
                                                    role="presentation" align="center" bgcolor="#383e56" style="">
                                                    <tr>
                                                        <td>
                                                            <table cellpadding="0" cellspacing="0" border="0"
                                ...
                                <table cellpadding="0" cellspacing="0" border="0" align="center" width="640"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td bgcolor="#f9f9f9" align="{{ getLocale() == 'ar' ? 'right' : 'left' }}"
                                                style="color:#5a5a5a;padding:10px 40px 10px 40px;font-family: 'Noto
                                                Kufi Arabic',
                                                sans-serif;font-weight:bold;font-size:14px;-webkit-font-smoothing:antialiased;line-height:1.4;">
                                                {{ __('mail.number_track') }} #
                                            </td>
                                            <td bgcolor="#f9f9f9" align="{{ getLocale() == 'ar' ? 'left' : 'right' }}"
                                                style="color:#5a5a5a;padding:10px 40px 10px 40px;font-family: 'Noto
                                                Kufi Arabic',
                                                sans-serif;font-weight:bold;font-size:14px;-webkit-font-smoothing:antialiased;line-height:1.4;">
                                                {{ $order->unique_id }}
                        ...
                        <tbody>
                            <tr>
                                <td style="padding:0 40px;">
                                    <table cellpadding="0" cellspacing="0" border="0"
                                        align="{{ getLocale() == 'ar' ? 'right' : 'left' }}" width="270"
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0"
                                        align="{{ getLocale() == 'ar' ? 'left' : 'right' }}" width="270"
                                        role="presentation" class="table-container">
                                        <tbody>
                                            <tr>
                                                <td height="20" style="line-height:20px;min-height:20px;">
