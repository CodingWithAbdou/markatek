        ...
        <div class="w-full max-w-screen-xl mx-auto p-6 md:py-8">
            <div class="sm:flex sm:items-center sm:justify-between">
                            ...
                            <li>
                                @if ($facebook)
                                    <a href="{{ $facebook }}" target="__blank"
                                        class="hover:opacity-75 transition duration-200 me-3 ">
                                ...
                                @if ($gmail)
                                    <a href="{{ $gmail }}" target="__blank"
                                        class="hover:opacity-75 transition duration-200 me-3 ">
                                        <i class='bx bxl-gmail text-2xl text-neutral-7700'></i>
                                    </a>
                                @endif
                            </li>
                        </ul>
                ...
                <ul class="flex gap-4 flex-wrap items-center mb-6 text-sm font-medium  sm:mb-0 secound_color_t">
                    ...
                    <li>
                        <img src="{{ asset('assets/images/visacard.png') }}" alt="">
                    </li>
                    <li>
                        <img class="w-12" src="{{ asset('assets/images/keynet.png') }}" width="200" alt="">
                    </li>
                </ul>
            </div>
